window.onload = function()
{
    ...
    */
    var validaRespuesta = function(id)
    {
        ...
        var correctoHorizontal = eval(respuesta.horizontal.ecuacion) === respustaMatriz.horizontal ? nom_div(respuesta.horizontal.div).style.background="green":nom_div(respuesta.horizontal.div).style.background="red";
        var correctoVertical = eval(respuesta.vertical.ecuacion) === respustaMatriz.vertical ? nom_div(respuesta.vertical.div).style.background="green":nom_div(respuesta.vertical.div).style.background="red";
        if(eval(respuesta.horizontal.ecuacion) === respustaMatriz.horizontal && eval(respuesta.vertical.ecuacion) === respustaMatriz.vertical){
          nom_div('txt-solucion').innerHTML = "Congratulations!";
          setTimeout(function(){
              location.reload();
          },5000);
        }
